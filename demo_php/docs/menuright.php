              <div class="col-lg-3 order-lg-1 mb-4">
                <a href="https://github.com/PreflightAPI/Examples" class="btn btn-block btn-primary mb-6">
                  <i class="fe fe-github mr-2"></i>Browse source code
                </a>
              
                <div class="list-group list-group-transparent mb-0">
                  <a href="../art?art=base" class="list-group-item list-group-item-action active"><span class="icon mr-3"><i class="fe fe-flag"></i></span>Introduction</a> 
                </div>
               
			     
                <div class="list-group list-group-transparent mb-0">
                  <a href="../docs/alerts.html" class="list-group-item list-group-item-action"><span class="icon mr-3"><i class="fe fe-alert-triangle"></i></span>sss</a>
